...
export class CubeCamera extends Object3D {
	...
	constructor( near: number, far: number, cubeResolution: number, options: any ) {
	...
	type = 'CubeCamera' as const;
	renderTarget: WebGLRenderTargetCube;

	update: ( renderer: any, scene: any ) => void;
	clear: ( renderer: any, color: Color, depth: number, stencil: any ) => void;
