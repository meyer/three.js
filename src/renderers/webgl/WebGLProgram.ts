...
function getEncodingComponents( encoding: any ): [string, string] {
...
function getTexelDecodingFunction( functionName: string, encoding: string ) {
...
function getTexelEncodingFunction( functionName: string, encoding: string ) {
...
function generateDefines( defines: Record<string, any> ) {
...
function fetchAttributeLocations(
	...
	var attributes: Record<string, number> = {};
...
function replaceLightNums( string: string, parameters: any ) {
...
function replaceClippingPlaneNums(
	string: string,
	parameters: Record<string, any>
) {
...
function unrollLoops( string: string ) {
	...
	function replace( match: any, start: any, end: any, snippet: string ) {
...
export class WebGLProgram {
	...
	cachedUniforms: WebGLUniforms | undefined;

	public getUniforms() {

		if ( this.cachedUniforms === undefined ) {

			this.cachedUniforms = new WebGLUniforms(
				this.gl,
				this.program,
				this.textures
			);
