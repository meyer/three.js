...
export type SixteenElementArray<T> = [
	T,
	T,
	T,
	T,
...
export class Matrix4 {
	...
	elements: SixteenElementArray<number>;
	...
	extractRotation = (  () => {
		...
		const extractRotation = ( m: Matrix4 ) => {
	...
	makeRotationFromQuaternion = (  () => {
		...
		const makeRotationFromQuaternion = ( q: Quaternion ) => {
	...
	applyToBufferAttribute = (  () => {
		...
		const applyToBufferAttribute = ( attribute: BufferAttribute ) => {
	...
	setPosition( x: number | Vector3, y?: any, z?: any ): Matrix4 {
	...
	decompose = (  () => {
		...
		const decompose = ( position: Vector3, quaternion: Quaternion, scale: Vector3 ) => {
